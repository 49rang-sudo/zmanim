...
export const defaultContent: SiteContentData = {
  ...
  hero: {
    ...
    subtitle:
      "בלי להילחם על פתיחת העיתון ובלי להיזרק לפח במוצאי שבת. לוח השנה של בני ברק מגיע ל-30,000 בתים בדיוור ישיר — ותופס את המקום הכי בולט בבית למשך מעגל שנה שלם.",
