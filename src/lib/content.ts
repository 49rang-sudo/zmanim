...
export const defaultLanding: LandingContent = {
  ...
  difference: {
    ...
    paragraphs: [
      ...
      "כל חודש מקבל סצנה משלו — בית, חדר, תקופה או עולם תוכן — והעסקים משתלבים בתוכה בצורה עדינה, ברורה ומדויקת.",
...
אפשר לחשוב בצורה יותר יצירתית ולמצוא הקשר מעניין😊`,
  ...
  pricing: {
    ...
    title: "אותו חודש. שתי רמות נוכחות.",
    intro:
      "אחרי שמצאתם את החודש שמתאים לעסק, בוחרים את רמת הנוכחות. בשתי האפשרויות העסק משתלב בתוך הסצנה של אותו חודש — ההבדל הוא בכמה מקום ובמה הוא מקבל בתוך הקונספט.",
    priceLabel: "מחיר:",
    anchor: {
      name: "מפרסם עוגן",
      text: "נוכחות רחבה ומשמעותית יותר בתוך הקונספט. העסק מקבל מקום מרכזי יותר בסצנה ויכול להיות מחובר לאלמנט מרכזי או לכמה נקודות נוכחות טבעיות.",
    ...
    multi: {
      ...
      anchorTitle: "תמחור למפרסמי עוגן — מספר חודשים",
      anchorRows: [
      ...
      complementaryTitle: "תמחור למפרסם משלים — מספר חודשים",
      complementaryRows: [
        "פרסום בודד בחודש אחד -1400 ש״ח",
        "2 פרסומים בחודשיים -1330 ש״ח לכל פרסום",
        "3 פרסומים -1260 ש״ח לכל פרסום",
        "מ-4 פרסומים ומעלה תקבלו 10% הנחה מהפרסום השני",
      ],
...
לוגו, פרטי קשר, מסר קצר והטבה - ומשם נבנית ההשתלבות בתוך הקונספט.`,
  ...
  howItWorks: [
    ...
    },
    {
      ...
      text: "בוחרים אם העסק נכנס כמפרסם עוגן עם במה רחבה יותר, או כמפרסם משלים עם נוכחות ממוקדת יותר, ורואים מראש את המחיר.",
    },
    {
...
השאלה היא איפה נכון שהלקוח יפגוש אתכם בצורה קבועה ולא רק בעיתון שהולך לפח תוך כמה ימים...`,
  ...
  wizard: {
    ...
    cityTitle: "באיזו מהדורה לפרסם?",
    citySubtitle:
      "לכל מהדורה פתוחה מלאי משבצות משלה. השלב הזה מוצג רק כשיש יותר ממהדורה פתוחה אחת — כרגע יש מהדורה פתוחה אחת, ולכן קופצים ישר לבחירת חודש ומקום.",
    ...
    cityFullMessage:
      "המהדורה הזו מלאה. אפשר להשאיר פרטים ונעדכן כשמתפנה מקום.",
    slotTakenMessage:
