...
/**
 * מחיר המשלים — 1400 ₪, בסיס אחיד לכל ארבעת המקומות (עודכן מטווח
 * 1200–1350 ₪ פר-מיקום, שהיה נהוג קודם — ראו scripts/migrate-
 * complementary-pricing.ts למחירי עבר שכבר נזרעו/נמכרו). עדיין
 * מערך, כדי שקוד הזריעה למטה (complementaryIndex) לא יזדקק לשינוי,
 * אבל כל הערכים בו זהים בכוונה.
 */
const COMPLEMENTARY_PRICES_AGOROT = [140_000, 140_000, 140_000, 140_000];
